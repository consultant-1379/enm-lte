...
# Purpose     : sets PICO UtranFreqRelation.utranFrequencyRef             
...
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount,$picotype=$currUtranFrequency\",attributes=\"utranFrequencyRef (moRef)=ManagedElement=$LTENAME,ENodeBFunction=1,UtraNetwork=1,UtranFrequency=$currUtranFrequency\";"
    );# end @MMLCmds 
