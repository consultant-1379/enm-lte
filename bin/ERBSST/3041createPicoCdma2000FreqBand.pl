...
# Purpose     : creates PICO Cdma2000Network.Cdma2000FreqBand
...
while ($NODECOUNT<=$PICONUMOFRBS){
 ...
 "createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,$Cdmanetwork=1\",type=\"$Cdma2000FreqBand\",name=\"$currCdma2000FreqBand\";"
     );# end @MMLCmds
