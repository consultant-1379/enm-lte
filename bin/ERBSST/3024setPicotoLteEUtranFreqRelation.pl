		...
		# build mml script
    		@MMLCmds=(".open ".$SIMNAME,
               ...
               "useattributecharacteristics:switch=\"off\";",
                "setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,$picocelltype=$LTENAME-$cellcount,$picoeutranfregrelation=$downLinkFreq\",attributes=\"eutranFrequencyRef (moRef)=ManagedElement=$LTENAME,ENodeBFunction=1,EUtraNetwork=1,$picotype=$downLinkFreq\";"
