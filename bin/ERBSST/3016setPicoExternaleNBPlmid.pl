...
# Purpose     : set PICO2PICO ExternalENodeBFunction.eNBPlmid             
...
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtraNetwork=1,$picotype=$tempstringnode\",attributes=\"eNodeBPlmnId (struct, PlmnIdentity)=[353,57,2]\";"
    );# end @MMLCmds
