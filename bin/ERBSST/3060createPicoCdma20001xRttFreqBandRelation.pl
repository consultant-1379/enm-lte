...
# Purpose     : creates PICO Cdma20001xRttFreqBandRelation
...
local $totalCdma2000FreqBand=2;
local $Cdma2000Freq="Cdma2000Freq";
local $currCdma2000Freq=1;
local $totalCdma2000Freq=2;
local $Cdma20001xRttFreqBandRelation="Cdma20001xRttBandRelation";
...
while ($NODECOUNT<=$PICONUMOFRBS){
    ...
    #####################################
    # start create PICO Cdma20001xRttFreqBandRelation
    #####################################
      	...
      	while ($currCdma20001xRttFreqBandRelation<=$totalCdma20001xRttFreqBandRelation)
	{
		...
		"createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount\",type=\"$Cdma20001xRttFreqBandRelation\",name=\"$currCdma20001xRttFreqBandRelation\";"
        	);# end @MMLCmds
