...
####################################################################
# Version1    : LTE 19.17
# Revision    : CXP 903 0491-355-1
# Purpose     : creates OAMAccesspoint MO in LTE nodes
# Description : creates IPV4Address MO and IPV6Address MO on
#               the 90:10 of the network in MT
...
# Purpose     : create AddressIPv4 in IPv4 nodes
# Description : OamAccessPoint", "AddressIPv4" and "AddressIPv6" MO changes does not apply in Netsim
# Jira        : NSS-34640
# Date        : March 2021
# Who         : xmitsin
####################################################################
