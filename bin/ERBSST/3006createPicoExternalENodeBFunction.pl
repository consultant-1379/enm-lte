...
# Purpose     : creates PICO ExternalENodeBFunction for PICO             
...
# Description : Setting MasterEnBFunctionId to 1 for all Proxies as SNAD
#               is setting them to 1
# Jira        : NETSUP-3523
...
"createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtraNetwork=1\",type=\"$picotype\",name=\"$tempstringnode\";",
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtraNetwork=1,$picotype=$tempstringnode\",attributes=\"masterEnbFunctionId  (String)=1\";"    
);# end @MMLCmds
