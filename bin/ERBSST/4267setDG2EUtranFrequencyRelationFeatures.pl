...
# Jira        : OSS-77951
# Purpose     : Created for Non-Planned PCI
...
#		Hybrid CSG
#	        csgPhysCellId = 486, csgPhysCellIdRange = 8
...
Example: $0  LTE16B-V12x160-RVDG2-FDD-LTE01 CONFIG.env 01);
if (!( @ARGV==3)){
   print "@helpinfo\n";exit(1);}
...
local $MIMsupportforNonPlannedPCI = "15B-V9";
local $MIMsupportforCSG = "16B-V5";
local $MIMsupportforhybridCSG = "16B-V5";
...
#========================================
 ...
 @MOCmds=qq( SET
     (
     mo "ManagedElement=$LTENAME,ENodeBFunction=1,$TYPE=$LTENAME-$cell_index,EUtranFreqRelation=$Frequency"
     exception none
     nrOfAttributes 2
     nonPlannedPhysCellIdRange Int32 $nonPlannedPCIRange
     nonPlannedPhysCellId Int32 $nonPlannedPCIId
    );
   );# end @MO
#========================================
...
#========================================
 ...
 @MOCmds=qq( SET
     ...
     exception none
     nrOfAttributes 2
     csgPhysCellIdRange Int32 $csgPhysCellIdRange
     csgPhysCellId Int32 $csgPhysCellId
    );
   );# end @MO
#========================================
# CSG PCI MO sets END
...
#========================================
 ...
 @MOCmds=qq( SET
     ...
     exception none
     nrOfAttributes 2
     hybridCsgPhysCellIdRange Int32 $hybridCsgPhysCellIdRange
     hybridCsgPhysCellId Int32 $hybridCsgPhysCellId
    );
   );# end @MO
#========================================
