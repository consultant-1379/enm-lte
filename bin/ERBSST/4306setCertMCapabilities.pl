...
####################################################################
# Version2    : LTE 16.12
# Revision    : CXP 903 0491-236-1
# User Story  : NSS-4942
# Purpose     : Change kertayle to make it independent of namespace.
# Description : Removing namespace to handle the changing namespace
#               and making it independent of namespace.
# Date        : July 2016
# Who         : xkatmri
####################################################################
####################
