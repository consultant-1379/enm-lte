...
# Purpose     : sets PICO Cdma2000FreqBandRelation
...
while ($NODECOUNT<=$PICONUMOFRBS){
    ...
    #####################################
    # start set PICO Cdma2000FreqBandRelation
    #####################################
...
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount,$Cdma2000FreqBandRelation=$currCdma2000FreqBandRelation\",attributes=\"$cdma2000FreqBandRef (moRef)=ManagedElement=$LTENAME,ENodeBFunction=1,$Cdmanetwork=1,$Cdma2000FreqBand=$currCdma2000FreqBandRelation\";"
        );# end @MMLCmds
