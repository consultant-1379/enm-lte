...
### VERSION HISTORY
####################################################################
# Verision1   : LTE 14.1.8
# Revision    : CXP 903 0491-42-19
# Purpose     : creates LTE2PICO ExternalENodeBFunction               
...
#               renaming script to 2270createLtetoPicoExternalEnodeBFunction.pl
...
#local $nodecountoffset=8000;	#int($NETWORKCELLSIZE / $CELLNUM28K) + 10;
...
#    $temppiconodecount+=$nodecountoffset;
    ...
    @MOCmds=qq( CREATE
      ...
      parent "ManagedElement=1,ENodeBFunction=1,EUtraNetwork=1"
       ...
       eNBId Integer $temppiconodecount
