...
# Purpose     : set PICO UtraNetwork.UtranFrequency.arfcnValueUtranDl            
...
while ($NODECOUNT<=$PICONUMOFRBS){
   ...
   "setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,UtraNetwork=1,$picotype=$currUtranFrequency\",attributes=\"arfcnValueUtranDl (int32)=$currUtranFrequency\";" 
       );# end @MMLCmds
