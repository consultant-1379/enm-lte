...
# Purpose     : creates PICO Cdma2000FreqBandRelation
...
"createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount\",type=\"$Cdma2000FreqBandRelation\",name=\"$currCdma2000FreqBandRelation\";"
        );# end @MMLCmds
