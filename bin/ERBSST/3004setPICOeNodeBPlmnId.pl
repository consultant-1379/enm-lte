...
# Purpose     : set PICO ManagedElement.ENodeBFunction.eNodeBPlmnId              
...
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1\",attributes=\"eNodeBPlmnId (struct, PlmnIdentity)=[353,57,2]\";"
    );# end @MMLCmds
