...
while ($NODECOUNT<=$PICONUMOFRBS){
      	...
      	while ($currCdma20001xRttFreqRelation<=$totalCdma20001xRttFreqRelation)
	{
      		...
      		while ($currCdma20001xRttCellRelation<=$totalCdma20001xRttCellRelation)
		{
			...
			"createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount,$Cdma20001xRttBandRelation=$currCdma20001xRttFreqBandRelation,$Cdma20001xRttFreqRelation=$currCdma20001xRttFreqRelation\",type=\"$Cdma20001xRttCellRelation\",name=\"$currCdma20001xRttCellRelation\";"	
			);# end @MMLCmds
