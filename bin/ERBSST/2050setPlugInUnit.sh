...
# Purpose     : Provide values for hardware type and name.
# Description : Provide values for hardware type, name and number for baseband nodes.
# Jira        : NSS-32192
# Date        : Sep 2020
# Who         : xmitsin
####################################################################
...
SET
(
  mo "ManagedElement=1,Equipment=1,Subrack=1,Slot=$COUNT,PlugInUnit=$COUNT"
    exception none
    nrOfAttributes 2
