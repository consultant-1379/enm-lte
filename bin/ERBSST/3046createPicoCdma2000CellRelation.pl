...
#
# Purpose     : creates PICO Cdma2000CellRelation
#
...
"createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount,$Cdma2000FreqBandRelation=$currCdma2000FreqBandRelation\",type=\"$Cdma2000CellRelation\",name=\"$currCdma2000CellRelation\";"
        );# end @MMLCmds
