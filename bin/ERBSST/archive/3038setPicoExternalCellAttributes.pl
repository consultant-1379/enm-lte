...
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,UtraNetwork=1,UtranFrequency=$currUtranFrequency,$picocelltype=$ExternalUtranCellFDDID\",attributes=\"$cellIdentity (struct, CellIdentityUtra)=[$ExternalUtranCellFDDID,$currUtranFrequency]\";",
"setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,UtraNetwork=1,UtranFrequency=$currUtranFrequency,$picocelltype=$ExternalUtranCellFDDID\",attributes=\"plmnIdentity (struct, PlmnIdentity)=[46,6,2]\";"
         );# end @MMLCmds
