...
# Purpose     : creates PICO Cdma2000Network.Cdma2000FreqBand.Cdma2000Freq
    ...
    while ($currCdma2000FreqBand<=$totalCdma2000FreqBand){# while Cdma2000FreqBand
     ...
     while($currCdma2000Freq<=$totalCdma2000Freq){# while Cdma2000Freq
       ...
       @MMLCmds=(".open ".$SIMNAME,
          ...
          "createmo:parentid=\"ManagedElement=$LTENAME,ENodeBFunction=1,$Cdmanetwork=1,$Cdma2000FreqBand=$currCdma2000FreqBand\",type=\"$Cdma2000Freq\",name=\"$currCdma2000Freq\";"
        );# end @MMLCmds
