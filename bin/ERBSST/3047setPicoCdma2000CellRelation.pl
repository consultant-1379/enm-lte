...
# Purpose     : sets PICO Cdma2000CellRelation.externalCdma2000CellRef
...
local $totalperFreqBandCdma2000CellRelation=2;
...
$ExternalCdma2000CellIDperNode[$arrcount]="ManagedElement=$LTENAME,ENodeBFunction=1,$Cdmanetwork=1,$Cdma2000FreqBand=$currCdma2000FreqBand,$Cdma2000Freq=$currCdma2000Freq,$ExternalCdma2000Cell=$ExternalCdma2000CellID";
    ...
    #####################################
    # start set PICO externalCdma2000CellRef
    #####################################
      $currCdma2000CellRelation=1;
      ...
      while ($currCdma2000FreqBandRelation<=$totalCdma2000FreqBandRelation){# start Cdma2000FreqBandRelation
        $counter=1;
        while ($counter<=$totalperFreqBandCdma2000CellRelation){# start while Cdma2000CellRelation

        $mmlstring="setmoattribute:mo=\"ManagedElement=$LTENAME,ENodeBFunction=1,EUtranCellFDD=$LTENAME-$cellcount,$Cdma2000FreqBandRelation=$currCdma2000FreqBandRelation,$Cdma2000CellRelation=$currCdma2000CellRelation\",
attributes=\"$externalCdma2000CellRef (moRef)=$ExternalCdma2000CellIDperNode[$arrcount]\";";
        ...
        @MMLCmds=(".open ".$SIMNAME,
          ...
          $mmlstring
             ...
             $counter++;
             $currCdma2000CellRelation++;
             $arrcount++;
          }# end while Cdma2000CellRelation
