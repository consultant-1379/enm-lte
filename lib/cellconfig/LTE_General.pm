...
sub getLTESimStringNodeName{
  ...
  if($simnum<=9){$simnodename="LTE0$simnum".$simType.$nodezeros.$nodecount;}
  else{		  $simnodename="LTE$simnum".$simType.$nodezeros.$nodecount;}# end else
